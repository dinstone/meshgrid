...
package com.dinstone.meshgrid.mesher;
...
import com.dinstone.meshgrid.mesher.verticle.HttpAdminVerticle;
import com.dinstone.meshgrid.mesher.verticle.HttpApiVerticle;
import com.dinstone.meshgrid.mesher.verticle.HttpProxyVerticle;
import com.dinstone.meshgrid.mesher.verticle.MeshVerticleFactory;
...
public class Activator {
    ...
    public void start() throws Exception {
        ...
        for (Object object : listenArray) {
            ...
            String type = listenConfig.getString("type");
            ...
            if ("http".equalsIgnoreCase(protocol) && "api".equalsIgnoreCase(type)) {
                ...
                LOG.warn("unkown listen service [{}].[{}]", protocol, type);
            }
        }
    }
