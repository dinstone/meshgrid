...
package com.dinstone.meshgrid.mesher.registry;
...
import com.dinstone.meshgrid.mesher.invoker.ServiceConsumer;
...
public class ServiceRegistry {
    ...
    public List<ServiceRecord> services() {
        ArrayList<ServiceRecord> l = new ArrayList<>();
        serviceRecordMap.values().forEach(r -> l.add(r));
        return l;
    }
